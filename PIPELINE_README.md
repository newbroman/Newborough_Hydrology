...
- `18_wtf_05_halflife_map.png` (supplementary) — report Figure 54
...
- `18_wtf_06_aquifer_diagnostic_synthesis.png` (supplementary) — report Figure 55
...
2. **C4 Main Forest has the largest shift** (highest β₂ = 2.57, most PET-sensitive); C1 Lake Edge and C5 Coastal Forest have the smallest (low β₂).
