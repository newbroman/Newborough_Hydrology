...
outputs/                       ← all generated outputs
  ...
  27_greyscale_figures/         ← step 38 post-processing utility writes here when invoked
...
### Phase 15 — Observed Differential Change and Envelope (Scripts 32–33)
...
Step 37 — `33_envelope_amplification.py` — the climate-swing amplification field and drought-floor surface (report Fig 60). Compares genuine wet/dry extremes (antecedent-matched) rather than two marginal windows: amplification = per-well wet-minus-dry swing ÷ network-mean swing (relative, common-mode removed; forest ~1.5×, lake ~0.6×); drought-floor = raw dry-extreme depth with the ecological threshold contoured. Reads the same three canonical inputs.
