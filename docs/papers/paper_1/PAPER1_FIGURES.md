...
| 15 | **DO NOT USE (D-199, Martin 2026-09-25): dropped from the report; the clusters no longer separate on ΔNSE.** `18_wtf_spatial/18_wtf_06_aquifer_diagnostic_synthesis.png` | `18_wtf_spatial/18_wtf_05_storage_drainage_index.csv`; `08_model_benchmarking/08_perwell_nse.csv`; `18_wtf_spatial/18_wtf_01_well_sy_estimates.csv` | 18 | Aquifer diagnostic synthesis (t½ vs ΔNSE, sized by Sy) | modelled |
