<!-- GENERATED MIRROR of docs/report/Newborough_Methods_Supplement_v1_9_75.odt — do not edit.
...
Document version: 1.9.75 (September 2026).
...
The three all-season linear-capped fits --- full network, forest-free and C3-only --- return δ₀ values in the range −29.1 to −31.7 mm yr⁻¹, L_cg values in the range 895--994 m, reference-distance rates of −24.5 to −27.4 mm yr⁻¹, and c_far values close to zero (−0.47 to −0.10 mm yr⁻¹). As the Cluster attribution note above sets out, c_far is not a far-field climate background: it is a window statistic rather than a rate.
