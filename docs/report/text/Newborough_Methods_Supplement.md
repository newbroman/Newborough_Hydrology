<!-- GENERATED MIRROR of docs/report/Newborough_Methods_Supplement_v1_9_53.odt — do not edit.
...
Document version: 1.9.53 (August 2026).
...
Inputs.
  ...
  δ_cwb₀, L                                         Script 25 *OUT_25_FIT_PARAMETERS*   Forest-free linear-capped fit; δ_cwb₀ = −29.03 mm yr⁻¹
...
#### []{#anchor-627}[]{#anchor-628}Scenario engine
  ...
  *summer_amplification_factors()*, *scenario_cluster_sy()*, *flux_to_summer_min_mm()*, *scenario_summer_min_bars()*   F.5 / *scraping_common.py*                                                                       Flux → summer-minimum helpers (retained but unused after 2026-07-02 volumetric re-basis; marked for removal)
  ...
  Tool A --- spring MSL transfer function                                                                              S.9 (§Sub-script 11 Methodology) / S.18b (§S.18b.2) / *11_forecasting_thresholds.py* Section 5   *MSL_y = α_B_W·h_max_winter + β·P_win_to_spr + γ·PET_win_to_spr + intercept*; R² 0.73--0.96; previous-MSL variant dropped at v1.1.1
