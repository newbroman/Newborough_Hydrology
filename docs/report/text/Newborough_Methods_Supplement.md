...
### []{#anchor-381}[]{#anchor-382}[]{#anchor-383}Outputs
  ...
  20_spatial_figures/20_coastal_erosion.png               Coastal-erosion drawdown field for a single Brendan-class retreat event; dune-edge front; δ₀ and L from live Script 25 fit                                                                                                                                                                                                 §3.4.5 *Drawdown-Field Visualisation* / §4.10.5 *Coastal-Margin Processes* (Figure)
