...
Six preset buttons configure all sliders to physically meaningful combinations:
  ...
  Clearfell      Complete canopy removal. Interception set to 0%, β₂ multiplier derived from BACI-corrected Edge-tier ratio (Script 10e; 1.032×, applied equally to both seasons).
  ...
  Thinning       50% canopy density reduction. Interception halved to 12%, β₂ set to 1.016× (half the clearfell BACI perturbation, applied equally to both seasons).
  -------------- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
