...
| 07 | 07_spatial_coefficients.py | 1.2.0 | 01_well_elevations.csv, 03_master_data.csv | 07_cluster_coeff_means.csv, 07_report_numbers.csv | (IDW surfaces, helper-saved) | MS | **DRIFT** |
| 08 | 08_model_benchmarking.py | 1.2.0 | 01_climate.csv, 01_wells_clean.csv, 02_cluster_stats.csv, 03_master_data.csv | 08_lcsc_04_table3_benchmark_summary.csv, 08_perwell_nse.csv, 08_report_numbers.csv | 08_lcsc_01_ceh6_showdown.png, 08_lcsc_02_r2_improvement_map.png, 08_lcsc_03_nse_improvement_map.png | MS | **DRIFT** |
| 09a | 09a_paired_baci.py | 2.7.2 | 01_wells_clean.csv, 03_master_data.csv | 09_scrape_01…04b_*.csv, 09_scrape_report_numbers.csv, 09_tier1_final_cusum.csv | 09_scrape_05_tier1_background_drift.png, 09_scrape_06_tier2_scraping_signal.png, 09_scrape_07_beta3_confidence.png | R8,MS,P2 | **OK** |
...
| 09d | 09d_scenario_comparison.py | 3.7.0 | 01_wells_clean.csv, 03_master_data.csv, 17_wtf_well_sy.csv, 20_report_numbers.csv | 09d_01_scenario_comparison.csv, 09d_02_summer_scenario_comparison.csv | 09d_01_scenario_comparison.jpg, 09d_02_summer_scenario_comparison.png | MS | **OK*** |
| 09e | 09e_robustness.py | 2.1.0 | 03_master_data.csv | 09e_report_numbers.csv | (panels) | MS | **OK** |
| 09f | 09f_management_effects.py | 1.7.0 | 03_03_cluster_mechanistic_coefficients.csv, 09b_01_individual_well_baci.csv, 09d_01_scenario_comparison.csv, 10a_report_numbers.csv, 10m_report_numbers.csv, 20_report_numbers.csv, 25_01_panel_fit_parameters.csv | 09f_01_reach_profile.csv | 09f_management_effects.png, 09f_management_effects_public.png | R8,MS,P1 | **DRIFT** |
| 09g | 09g_mechanism_diagrams.py | 1.2.0 | 09f_01_reach_profile.csv, 10a/10m report_numbers | — | 09g_mechanism_grid.png/.svg, 09g_coastal_vs_climate_reach.png/.svg | R8,MS,P1 | **OK** |
| 10a | 10a_ancova_baci.py | 1.5.0 | (clearfell_common; raw BACI) | 10a_report_numbers.csv, 10a_01_ancova_comparison_table.csv | 10a_04…08 + S1–S3 | R8,MS | **OK-TR** |
...
| 10c | 10c_forest_zone_analysis.py | 1.0.0 | 06_pear_membership_audit_sitewide.csv, 07_coeff_maps_data.csv | 10c_forest_zone_correlations.csv, 10c_forest_zone_cluster_summary.csv, 10c_04_forest_zone_summary.txt | 10c_01_b1_b2_scatter.png, 10c_02_b2_elevation_regression.png, 10c_03_c4_c5_boundary_map.png | MS | **OK** |
...
| 10f | 10f_robustness.py | 1.1.0 | (BACI) | 10f_01_ssm_residual_results.csv, 10f_02_synthetic_control_results.csv, 10f_report_numbers.csv | — | MS | **OK** |
...
| 10h | 10h_synthetic_impact_baci.py | 1.4.0 | (donors CEH34/2/33) | (synthetic control) | — | MS | **DRIFT-min** |
...
| 10k | 10k_four_zone_baci.py | 1.3.0 | 10j_01_monthly_contrast_results.csv | 10k_01_four_zone_results.csv, 10k_02_pairwise_contrasts.csv, 10k_03_easting_sensitivity.csv, 10k_report_numbers.csv | 10k_04…06 | MS | **OK** |
...
| 11b | 11b_spatial_thresholds.py | 1.6.2 | 03_master_data.csv, 11_forecast_* , 06_pear_… | 11b_03_pflood_per_well.csv, 11b_05_table10_pflood_spreadsheet.csv | 11b_01…04 | MS | **OK** |
...
| 17 | 17_wtf_specific_yield.py | 1.4.1 | 03_master_data.csv | 17_wtf_01_sy_estimates.csv, 17_wtf_04_summary.txt | 17_wtf_02_regression.png, 17_wtf_03_event_boxplot.png, 17_wtf_05_rapid_events.png | MS | **OK** |
| 18 | 18_wtf_spatial.py | 1.9.0 | 03_master_data.csv, 06_pear_…, 08_lcsc_model_stats.csv (+01/02) | **17_wtf_well_sy.csv** (per-well, legacy prefix), 18_wtf_01_well_sy_estimates.csv, 18_wtf_05_storage_drainage_index.csv, 18_wtf_07_sy_spatial_trends.csv, 18_report_numbers.csv | 18_wtf_02_spatial_sy_map.png, 18_wtf_03/04_sy_contour*.png, 18_wtf_05_halflife_map.png, 18_wtf_06_aquifer_diagnostic_synthesis.png | MS | **DRIFT-attr** |
| 19 | 19_spatial_groundwater.py | 2.10.0 | 03_master_data.csv, 18_wtf_01_well_sy_estimates.csv (per-well Sy) (+01/02) | 19_scenario_summary.csv, scenario_viewer.html | — | MS,SM | **OK** |
...
| 26b | 26b_van_willegen_msl_projections.py | 1.2.0 | 01_climate.csv, **03_03_cluster_mechanistic_coefficients.csv** (pre-fitted β), 26_msl_5yr_per_cluster_centroid.csv | 26b_msl5_ukcp18_projection_summary*.csv, 26b_monthly_delta_h_per_cluster.csv | 26b_msl5_ukcp18_projection.png | R8,MS | **DRIFT** |
...
| 29 | 29_c3_within_variance_check.py | 1.4.0 | 03_master_data.csv | 29_within_c3_variance.csv, 29_univariate_R2.csv, 29_drop_one.csv, 29_report_numbers.csv | 29_within_c3_variance_panel.png | R8,MS | **DRIFT** |
| 30 | 30_c4_drainage_identifiability.py | 2.1.0 | 01_climate.csv, 01_wells_clean.csv, 02_cluster_stats.csv | 30_c4_identifiability_by_cluster.csv, 30_c4_perwell_beta3.csv, 30_c4_report_numbers.csv | 30_c4_drainage_identifiability.png | R8,MS | **DRIFT** |
| 31 | 31_cluster_validation.py | 1.4.0 | 01_dry_depths.csv, 01_well_elevations.csv, 01_wells_clean.csv, 03_master_data.csv, 17_wtf_well_sy.csv | 31_validation_summary.csv, 31_forest_confusion.csv, 31_method_robustness_ari.csv, 31_forest_borderline.csv | 31_cluster_validation_panel.png | R8,MS | **OK** |
...
| 32 | 32_differential_movement.py | 1.2.0 | 01_locations.csv, 01_wells_clean.csv, 03_master_data.csv | 32_differential_movement_per_well.csv, 32_site_mean_trend.csv, 32_results.txt | 32_differential_movement_2005_2025.png, 32_differential_movement_2011_2025.png | R8,MS,SM | **OK*** |
| 33 | 33_envelope_amplification.py | 1.3.0 (live 1.4.0) | 01_locations.csv, 01_wells_clean.csv, 03_master_data.csv, 06_pear_membership_audit_sitewide.csv | 33_envelope_per_well.csv, 33_envelope_per_well_recent.csv, 33_results.txt | 33_amplification_field.png (Fig 65), 33_dry_spring_depth.png (Fig 66), +_recent variants | R8,MS,SM | **DRIFT** |
| 34 | 34_window_sensitivity.py | 0.5.0 | 00_01_annual_climate_summary.csv, 26_msl_annual_per_well.csv, 32_site_mean_trend.csv | 34_window_matrix.csv, 34_results.txt | 34_window_sensitivity.png | R8,MS,SM | **OK** |
...
| 37b | 37b_driver_footing.py | 1.2.0 | 01_wells_clean.csv, 03_master_data.csv, 09_scrape_03_baci_shifts.csv, 10a_report_numbers.csv, 10m_report_numbers.csv, 20_report_numbers.csv, 25_01_panel_fit_parameters.csv | 37b_driver_footing.csv, 37b_results.txt | 37b_driver_footing.png | R8,MS | **DRIFT** |
