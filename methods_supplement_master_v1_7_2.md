...
*Document version: 1.7.2 (June 2026).*
...
The greyscale figure-conversion utility (`27_greyscale_figures.py`) is step 43 of the pipeline and sits in Phase 17 as a single-script post-processing phase.
