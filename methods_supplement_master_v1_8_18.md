# []{#anchor}Newborough Warren Methods Supplement
...
Document version: 1.8.18 (August 2026).

## []{#anchor}Pipeline at a glance

*run_analysis.py*** --- 49 steps across 17 phases** (canonical count: committed *outputs/pipeline_manifest.json*, emitted on every run --- cite that, not this line, if the two ever disagree) 46 analytical steps across 17 phases, plus 4 display/utility steps (Scripts 26c, 09f, 09g, 27) excluded from the analytical count. The remainder are opt-in supplementary diagnostics --- Scripts 24b, 31 and 31b, the Phase 16 remainder --- which run only with *\--with-supplementary*.
...
# []{#anchor}F.2 Field protocol, bucketing convention, and date semantics
...
### []{#anchor}History: why HEADLINE_LAG was 1 and is now 0
...
### []{#anchor}Note on maOD invariance to ground-surface change
...
### []{#anchor}Reporting dates in the report and supplement
...
### []{#anchor}Hydrology year conventions
...
# []{#anchor}F.3 The state-space model --- displacement formulation
...
### []{#anchor}Implementation: *model_utils.fit_ssm()*
...
### []{#anchor}Two regimes: no-intercept (A) and with-intercept (B)
...
### []{#anchor}Sanity-check assertions
...
# []{#anchor}F.4 Configuration, constants, and the cluster partition
...
### []{#anchor}The identity-vs-integer keying principle
...
### []{#anchor}Specific yield: two values per cluster
...
### []{#anchor}Scripts in the post-Phase-2 region --- naming and step assignment
...
-   **Script 32** (*32_differential_movement.py*) --- Secular differential water-table movement; report Figure 63. Step 36/49, Phase 15. Documented in S.20.1.
-   **Script 33** (*33_envelope_amplification.py*) --- Climate-swing amplification and dry-year spring floor; report Figures 65 and 66. Step 37/49, Phase 15. Documented in S.20.2.
-   **Script 35** (*35_per_well_amplification.py*) --- Per-well climate-sensitivity coefficient (discrete companion to the Figure 65 surface). Step 38/49, Phase 15. Documented in S.20.3.
...
### []{#anchor}MSL aggregation --- constants and conventions
...
# []{#anchor}F.5 Shared utility modules
...
### []{#anchor}How the modules compose
...
# []{#anchor}Phase 1 --- Core LCSC Chain

## []{#anchor}S.1 Script 01 --- Data preparation
...
### []{#anchor}Where the result appears in the report
...
## []{#anchor}S.2 Script 02 --- Behavioural clustering
...
### []{#anchor}Site-specific choices and rationale
...
## []{#anchor}S.3 Script 03 --- State-space regression and LCSC
...
# []{#anchor}Phase 2 --- Pearson Membership Audit

## []{#anchor}S.4 Scripts 04, 05, 06 --- Cluster visualization and Pearson affinity audits

Steps 4--6 / 27. Phase 2.

### []{#anchor}Motivation (chapter-level)
...
### []{#anchor}Sub-script 04 --- Cluster orientation map (*04_cluster_visualisations.py*)
...
### []{#anchor}Sub-script 05 --- Pearson affinity (reference network, *05_pearson_affinity.py*)
...
### []{#anchor}Sub-script 06 --- Pearson affinity (sitewide / extended, *06_pearson_extended.py*)
...
### []{#anchor}Site-specific choices and rationale (chapter-level)
...
### []{#anchor}Limitations and known caveats (chapter-level)
...
## []{#anchor}S.5 Scripts 07, 08 --- Spatial coefficient maps and LCSC model benchmarking
...
### []{#anchor}Sub-script 07 --- Spatial coefficient mapping
...
### []{#anchor}Sub-script 08 --- LCSC model benchmarking
...
# []{#anchor}Phase 3 --- Model Diagnostics and Intervention Analysis

## []{#anchor}S.6 Script 09 suite (a--e) --- Scraping intervention
...
### []{#anchor}Sub-script 09a --- Hierarchical paired BACI
...
### []{#anchor}Sub-script 09b --- Scraping propagation
...
### []{#anchor}Sub-script 09c --- Summer minima
...
### []{#anchor}Sub-script 09d --- Scenario comparison
...
### []{#anchor}Sub-script 09e --- Robustness
...
### []{#anchor}Suite-level methodology
...
### []{#anchor}Site-specific choices and rationale (suite-level)
...
### []{#anchor}Limitations and known caveats (suite-level)
...
### []{#anchor}Sub-script 10a --- Three-counterfactual ANCOVA-BACI
...
### []{#anchor}Sub-script 10b --- Spatial step-change maps
...
### []{#anchor}Sub-script 10d --- Summer minima (dual-control)
...
### []{#anchor}Sub-script 10e --- SSM coefficient shift diagnostic
...
### []{#anchor}Sub-script 10f --- Robustness
...
### []{#anchor}Sub-script 10g --- Diagnostics
...
### []{#anchor}Sub-script 10h --- Synthetic FE-well extension BACI
...
### []{#anchor}Sub-script 10i --- CEH34 donor-regression hindcast
...
### []{#anchor}Sub-script 10j --- Direct Impact-vs-Edge contrast
...
### []{#anchor}Sub-scripts 10k and 10l --- Four-zone pooled-panel BACI
...
### []{#anchor}Supplementary --- Sub-script 10c --- Forest zone analysis
...
### []{#anchor}Methodology (suite-level) --- *clearfell_common.py*
...
### []{#anchor}Sub-script 10m --- WMC3 BACI dual-panel display figure (v1.0.0)
...
### []{#anchor}Sub-script 00 --- Climate summary
...
### []{#anchor}Sub-script 12 --- Site overview map
...
### []{#anchor}Sub-script 13 --- Experimental design map
...
### []{#anchor}Sub-script 14 --- Climate projections
...
### []{#anchor}Site-specific choices (suite-level)
...
### []{#anchor}S.8.5 Script 14b --- Bootstrap year-of-crossing (post-review addition, Phase 4 step 16)
...
### []{#anchor}Sub-script 11 --- Cluster-level temporal forecasting
...
#### []{#anchor}Site-specific choices (Script 11)
...
### []{#anchor}Sub-script 11b --- Per-well spatial threshold maps
...
#### []{#anchor}Site-specific choices (Script 11b)
...
### []{#anchor}Site-specific choices and limitations (suite-level)
...
### []{#anchor}S.9.3 Script 11c --- P_flood achievability map (post-review addition, Phase 3 step 13)
...
## []{#anchor}S.10 Script 15 --- Depth-dependent PET sensitivity
...
### []{#anchor}Results to describe at the methodological level
...
## []{#anchor}S.11 Script 16 --- Water balance decomposition
...
#### []{#anchor}The head-space decomposition
...
#### []{#anchor}From head-space to volume
...
#### []{#anchor}Recession as an independent check
...
#### []{#anchor}Interception and the energy budget
...
### []{#anchor}Outputs
  ...
  ------------------------------ --------------------------------------------------------------------------------------------------------------------------------------------------- --------------------------------
  *16_water_bal_table.csv*       Table 3a: head-space decomposition per cluster --- β triplet, P̄, PET̄, h̄\_disp, recharge, ET draw, drainage, residual, drainage and ET percentages   Report §4.2.3, Table 3a
...
## []{#anchor}S.12 Scripts 17, 18 --- WTF Specific Yield (cluster and spatial)
...
### []{#anchor}Sub-script 17 --- *17_wtf_specific_yield.py* (cluster-level Sy)
...
#### []{#anchor}Outputs
  ...
  ------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ---------------------------------------------------------------
  *17_wtf_01_sy_estimates.csv*    Per-cluster Approach A and B estimates with SE/IQR and n; corrected variants for forest clusters; six *Sy_rapid\_\** columns for Approach C (median, 95 % CI bounds, n, bootstrap seed)   Script 19, Script 21, Table 3c
...
### []{#anchor}Sub-script 18 --- *18_wtf_spatial.py* (per-well Sy and the drainage half-life map)
...
## []{#anchor}S.13 Scripts 19, 20 --- Spatial groundwater analysis
...
### []{#anchor}Sub-script 19 --- Scenario viewer (interactive HTML)
...
### []{#anchor}Sub-script 20 --- Publication spatial figures
...
#### []{#anchor}Coastal-process figures (erosion, sea-level-rise, and net coastal change)
...
#### []{#anchor}Dune-scrape topographic-drain drawdown (*20_scrape_drawdown_nohead.png*)
...
#### []{#anchor}Clearfell pre-fell baseline drawdown composite (*20_clearfell_baseline_drawdown.png*)
...
#### []{#anchor}Public summary three-driver comparison panel (*20_public_drivers_panel.png*)
...
#### []{#anchor}Net water-table state map (*20_net_state_map.png*)
...
#### []{#anchor}Modelled 2005→2025 driver-change map (*20_driver_change_2005_2025.png*)
...
#### []{#anchor}Shared drawdown scale across the four drivers
...
## []{#anchor}S.14 Script 21 --- Forestry scenarios
...
-   **§4.9.6 *****Forestry scenarios*** --- script figures 21-01 (synthetic hydrograph) and 21-02 (distributions); the headline narrative on clearfell, thinning, and broadleaf at C4; the BACI-modelled gap.
-   **§4.9.6** --- script figure 21-05 (scenario comparison panel) for the cross-cluster volumetric summary.
-   **§4.5 and §4.6 cross-links** --- script figures 21-03 (scraping-era) and 21-04 (BACI tier violins) where the forestry chapter draws on the scraping and BACI evidence for context.
...
# []{#anchor}Phase 5 --- Post-pipeline supplementary analyses
...
## []{#anchor}S.15 Script 25 --- Coastal-retreat gradient
...
### []{#anchor}Two-pass execution and defaults
...
## []{#anchor}S.15d Script 09g --- Four-driver mechanism diagrams (§5.8 schematic figure)
...
### []{#anchor}Where the result appears
...
## []{#anchor}S.16 Scripts 22, 23, 24 --- Residual diagnostics
...
### []{#anchor}Methodology --- Script 22 (residual lag analysis)
...
### []{#anchor}Methodology --- Script 22 (headline-SSM residual inference)
...
### []{#anchor}Methodology --- Script 23 (ridge recharge lag test)
...
### []{#anchor}Methodology --- Script 24 (residual seasonality)
...
### []{#anchor}Diagnostic --- cluster-stratified residual climatology (Script 24b, non-pipeline)
...
-   **Full record vs Script 07's 100-month window.** Scripts 22 and 24 use the full per-well record to maximize statistical power for the lag and seasonality analyses, which need as many monthly observations as possible. The trade-off is that the Model B fits here are not identical to Table 2 / Figure 48b in the main report. The supplement's headline coefficients remain the 100-month-window fits; Scripts 22, 23, 24 are diagnostic companions, not revisions.
...
-   **S.13** --- Figure 58 (SSM water-balance residual map) is the visual the diagnostic suite is interrogating; the CEH14 annotation on that figure is the headline well around which the §5.3 interpretation is anchored.
...
## []{#anchor}S.18 Script 26 --- Van Willegen MSL aggregation and Equilibrium Wetness Index
...
### []{#anchor}Empirical relationship to summer minima
...
### []{#anchor}Climate context for the post-2024 trajectory lift
...
### []{#anchor}Intervention markers and the management-response horizon
...
### []{#anchor}Method A and Method B aggregation
...
### []{#anchor}Where the result appears in the report
  ...
  -------------------------------------------------------------------- -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  §4.8.4 *Five-Year Mean Spring Water Level (MSL5)*                    **Table 16** (cluster-mean MSL5 at window-end 2025 with SD15b/SD16 threshold-crossing counts, source *26_msl_5yr_per_cluster.csv*), the cluster trajectory plot (**Figure 43**) and the spatial MSL5 map (**Figure 44**); the results narrative
...
### []{#anchor}Equilibrium wetness index and vegetation cross-validation (v1.3.2)
...
## []{#anchor}S.18b --- Spring MSL forecasting tools (Script 11 Section 5, Script 26b)
...
### []{#anchor}S.18b.1 Purpose and editorial weighting
...
### []{#anchor}S.18b.2 Tool A: empirical spring MSL transfer function

#### []{#anchor}S.18b.2.1 Specification
...
#### []{#anchor}S.18b.2.4 A rejected variant
...
#### []{#anchor}S.18b.2.5 Manager workflow
...
### []{#anchor}S.18b.3 Tool B: UKCP18 RCP8.5 MSL5 climate projection

#### []{#anchor}S.18b.3.1 Specification
...
#### []{#anchor}S.18b.3.3 What the projection is and is not
...
#### []{#anchor}S.18b.3.5 The spring-window structural cancellation
...
#### []{#anchor}S.18b.3.6 Climate signal in context
...
#### []{#anchor}S.18b.3.7 Relationship to the Curreli summer-minimum predictions
...
#### []{#anchor}S.18b.3.8 A parallel per-well aggregation pathway
...
### []{#anchor}S.18b.4 Tool C: Equilibrium Wetness Index (EWI) MSL5 prediction
...
### []{#anchor}S.18b.5 Method A and Method B aggregation
...
### []{#anchor}S.18b.6 Pipeline integration
...
### []{#anchor}S.18b.7 Data sources and reproducibility
...
## []{#anchor}S.18c Script 26c --- Report-format MSL5 figures
...
## []{#anchor}S.19 Scripts 28, 29, 30 --- Cluster framework diagnostics (Phase 14)
...
### []{#anchor}S.19.1 Script 28 --- C3 detrend check
...
### []{#anchor}S.19.2 Script 29 --- Within-C3 variance attribution
...
### []{#anchor}S.19.3 Script 30 --- C4 constrained-β₃ triangulation sensitivity and water-balance partition
...
## []{#anchor}S.20 Scripts 32, 33, 35, 36, 37, 37b --- Observed differential change and the climate-response envelope
...
### []{#anchor}S.20.1 Script 32 --- Secular differential water-table movement (Figure 63)
...
### []{#anchor-1}S.20.2 Script 33 --- Climate-swing amplification and dry-year spring floor (Figures 65 and 66)
...
### []{#anchor-2}S.20.3 Script 35 --- Per-well climate-sensitivity coefficient
...
### []{#anchor-2}S.20.4 Script 36 --- Absolute climate-removed secular trend (Phase 15)
...
### []{#anchor-2}S.20.5 Script 37 --- Driver validation (per-driver scale-factor regression)
...
### []{#anchor-2}S.20.6 Script 37b --- Comparative driver footing (Part B)
...
## []{#anchor-2}S.21 Scripts 24b, 31, 31b, 34, 38 --- Supplementary standalone diagnostics
...
### []{#anchor-2}S.21.1 Script 24b --- Cluster-stratified residual climatology
...
### []{#anchor-2}S.21.2 Script 31 --- Independent k=5 partition validation
...
### []{#anchor-2}S.21.3 Script 31b --- Cluster separation versus recoverability
...
### []{#anchor-2}S.21.4 Script 34 --- MSL5 two-window sensitivity demonstration
...
### []{#anchor-2}S.21.5 Script 38 --- Coast-to-inland MAM transect (observational δ₀)
...
### []{#anchor-2}A. Greyscale figure post-processing --- Script 27
...
Script 27's filename prefix (*27\_*) and orchestrator step number (49/49) deliberately do not match --- the same convention applied to Script 26 (*26_van_willegen_msl.py* at step 30/49), Script 26b (*26b_van_willegen_msl_projections.py* at step 31/49), Script 26c (*26c_msl5_report_figures.py* at step 32/49), Script 09f (*09f_management_effects.py* at step 47/49), and Script 09g (*09g_mechanism_diagrams.py* at step 48/49). The filename groups Script 27 alphabetically with the other *2x\_* scripts; the orchestrator number reflects its position in the run order at the end of Phase 17. Under the supplement's analytical-step count (46 steps, Phases 1--17 of *run_analysis.py*), Script 27 has no analytical-step number --- it is the post-analysis utility documented in this appendix. Script 26c, the MSL5 report-format figure-rendering companion, is similarly excluded from the analytical count and is documented in §S.18c. Script 09f, the spatial-reach synthesis figure, is also excluded and is documented in §S.15c. Script 09g, the mechanism-diagram companion to 09f, is likewise excluded and is documented in §S.15d.

### []{#anchor-2}B. Canonical sources of truth --- reference table
...
#### []{#anchor-2}Partition and cluster constants
...
#### []{#anchor-2}Forest and forest scenarios
...
#### []{#anchor-2}Intervention machinery
...
#### []{#anchor-2}Ecological thresholds
...
#### []{#anchor-2}Residuals and diagnostics
...
#### []{#anchor-2}Climate and field data
...
#### []{#anchor-2}Orchestration and rendering
