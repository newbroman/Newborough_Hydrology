...
Document version: 1.9.1 (August 2026).
...
Script 22 refits Model B --- the SSM with a constant intercept --- on the 66 reference wells, using the full record, on the full record rather than the 100-month recent window used by Script 07. The model is the canonical displacement-formulation SSM with an additive constant:
