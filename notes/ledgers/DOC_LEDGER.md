...
|---|---|---|---|
| `docs/academic_summaries/academic_summary.pdf` | `academic_Summary_v1_20.odt` | 2026-09-20T22:45:28Z | current |
| `docs/academic_summaries/crynodeb_academaidd.pdf` | `crynodeb_academaidd_v1_15.odt` | 2026-09-20T22:45:30Z | current |
| `docs/papers/paper_1/PAPER1_SI_methods.pdf` | `PAPER1_SI_methods_v1_20.odt` | 2026-09-20T22:45:36Z | current |
| `docs/papers/paper_1/Paper1.pdf` | `Paper1_v1_46.odt` | 2026-09-20T22:45:35Z | current |
| `docs/papers/paper_2/Hollingham_2026_Paper2_amended.pdf` | `Hollingham_2026_Paper2_amended_v21.odt` | 2026-09-20T22:45:35Z | current |
...
*Generated 2026-09-21 by `tools/build_doc_ledger.py` v1.1.0.*
