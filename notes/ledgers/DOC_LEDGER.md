...
**12 published PDFs** — 4 version-current, 3 lagging, 5 unversioned (mtime-only, not version-tracked).

| Published PDF | Source ODT (recorded) | Built (UTC) | State |
|---|---|---|---|
| `docs/academic_summaries/academic_summary.pdf` | `academic_Summary_v1_20.odt` | 2026-09-23T07:41:18Z | **STALE** |
| `docs/academic_summaries/crynodeb_academaidd.pdf` | `crynodeb_academaidd_v1_15.odt` | 2026-09-20T22:45:30Z | **STALE** |
...
| `docs/report/Newborough_Methods_Supplement.pdf` | `Newborough_Methods_Supplement_v2_0_15.odt` | 2026-09-23T07:41:14Z | **STALE** |
| `docs/report/Supplementary_Material.pdf` | `Supplementary_Material_v1_32.odt` | 2026-09-23T07:41:16Z | current |
...
*Generated 2026-09-24 by `tools/build_doc_ledger.py` v1.1.0.*
