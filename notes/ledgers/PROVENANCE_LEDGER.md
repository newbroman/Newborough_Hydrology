...
| `06_pear_01_affinity_chart_extended.png` | report9.odt | Figure 14 | Figure 1.11: Pearson affinity analysis of selected reference and extended networ |
...
| `09_scrape_07_beta3_confidence.png` | report9.odt | Figure 21 | Figure 1.18: Era-specific β₃ storage decay coefficients with 95% confidence inte |
| `09_scrape_08_ceh36_robustness.png` | Paper 2 | Figure 1 | CEH36 three-method scraping robustness |
|  | report9.odt | Figure 20 | Figure 1.17: Three-method robustness assessment of the scraping signal at CEH36. |
| `09b_03_ceh36_equilibration.jpg` | report9.odt | Figure 25 | Figure 1.22: Climate-corrected anomaly trajectory at CEH36 (scraped) vs CEH4 (co |
| `09c_03_summer_minima_climate_ctrl.png` | report9.odt | Figure 23 | Figure 1.20: Summer minima analysis for the scraping intervention against the cl |
...
| `09f_management_effects.png` | report10.odt | Figure 81 | Figure 1.2: Spatial reach and development timescale of the management interventi |
| `09g_coastal_vs_climate_reach.png` | Paper 1 | Figure 21 | Conceptual coastal-vs-climate reach |
| `09g_mechanism_grid.png` | report10.odt | Figure 82 | Figure 1.3: Three drivers of water-table change and the undisturbed state — sche |
...
|  | report9.odt | Figure 31 | Figure 1.28: Forest control BACI timeseries and CUSUM for the Impact tier (WMC3) |
| `10a_08_cusum_edge.png` | report9.odt | Figure 32 | Figure 1.29: Forest control BACI timeseries and CUSUM for the Edge tier (CEH31, |
| `10a_14_era_split_decay.png` | report9.odt | Figure 39 | Figure 1.36: Early versus late clearfell BACI step against the Forest control, s |
...
| `10d_04_summer_minima_forest_ctrl.png` | report9.odt | Figure 33 | Figure 1.30: Summer minima analysis against the Forest control. (a) Raw annual s |
...
| `10g_02_clearfell_transect.png` | report9.odt | Figure 37 | Figure 1.34: Clearfell transect. (a) Monthly depth anomaly against each well&apo |
...
| `11c_pflood_achievability.png` | report10.odt | Figure 83 | Figure 1.4: Per-well achievability categorization against the P_flood rainfall m |
...
| `14b_year_of_crossing.png` | report9.odt | Figure 47 | Figure 1.44: Bootstrap year-of-crossing for the five-cluster summer-minimum tren |
...
|  | report9.odt | Figure 55 | Figure 1.52: Aquifer diagnostic synthesis across the reference well network, New |
| `20_clearfell_baseline_drawdown.png` | report9.odt | Figure 67 | Figure 1.64: Combined drawdown imposed on the clearfell pre-fell baseline (Oct 2 |
| `20_clearfell_gain.png` | report9.odt | Figure 68 | Figure 1.65: Clearfell step-change map — climate-corrected mean water-table shif |
| `20_coastal_erosion.png` | Paper 1 | Figure 20 | Episodic coastal-retreat reach |
|  | report9.odt | Figure 62 | Figure 1.59: Coastal-erosion drawdown at the western dune margin, Newborough War |
| `20_coastal_net_effect.png` | report9.odt | Figure 64 | Figure 1.61: Net coastal-margin change at the western dune margin: the cell-by-c |
...
|  | report9.odt | Figure 65 | Figure 1.62: Forest drawdown propagation across the Newborough Warren dune aquif |
| `20_driver_change_20yr.png` | report9.odt | Figure 70 | Figure 1.67: Modelled water-table change across Newborough Warren, 2005–2025 — f |
| `20_head_surface_streams.png` | Paper 1 | Figure 16 | Mean head surface + normalised Darcy vectors |
|  | report9.odt | Figure 56 | Figure 1.53: Mean annual water table elevation (m AOD) across the Newborough War |
| `20_head_vs_dem.png` | report9.odt | Figure 57 | Figure 1.54: Mean water table (2005–2026) against the ground surface, by DEM smo |
| `20_msl5_change_2017_2023.png` | report9.odt | Figure 71 | Figure 1.68: Observed MSL5 change: window end 2017 (springs 2013–2017, pre-clear |
| `20_net_state_map.png` | report9.odt | Figure 69 | Figure 1.66: Net water-table state — parametric combination of five simultaneous |
...
|  | report9.odt | Figure 58 | Figure 1.55: SSM water balance residual across the Newborough Warren dune aquife |
| `20_scrape_drawdown_nohead.png` | Paper 2 | Figure 8 | Scrape-induced drawdown / cascade |
|  | report9.odt | Figure 66 | Figure 1.63: Dune-scrape drawdown across all eight mapped cuts, Newborough Warre |
| `20_slr_response.png` | report9.odt | Figure 63 | Figure 1.60: Sea-level-rise head response at the western dune margin, on the sam |
| `21_forestry_01_hydrograph.png` | report10.odt | Figure 80 | Figure 1.1: Synthetic mean-year hydrograph for the C4 Forest cluster under four |
...
|  | report9.odt | Figure 59 | Figure 1.56: Network-scale coastal-retreat gradient. Per-well summer-minimum slo |
...
| `25_13_rolling_window.png` | report9.odt | Figure 60 | Figure 1.57: Fixed-length rolling-window sensitivity of the cross-shore decay fi |
...
| `32_differential_movement_2011_2025.png` | report9.odt | Figure 72 | Figure 1.69: Secular differential movement of the spring (March,April, May) wate |
| `33_amplification_field.png` | report9.odt | Figure 74 | Figure 1.71: The climate-response envelope of the spring water table. Relative a |
| `33_dry_spring_depth.png` | report9.odt | Figure 75 | Figure 1.72: The climate-response envelope of the spring water table: Dry-year s |
| `36_absolute_climate_trend_2005_2025.png` | report9.odt | Figure 73 | Figure 1.70: Absolute climate-removed secular trend of the spring (March, April, |
| `37_implied_delta0_trajectory.png` | report9.odt | Figure 76 | Figure 1.73: Independent test of the chronic coastal-drying assumption: implied |
...
| `37b_driver_footing.png` | report9.odt | Figure 77 | Figure 1.74: Comparative footing of the drivers over the 2005–2025 horizon, on t |
| `38_coast_inland_difference.jpg` | report9.odt | Figure 61 | Figure 1.58: Independent, model-free estimate of the coastal drawdown rate. The |
...
| `44_07b_hindcast_report.png` | report9.odt | Figure 79 | Figure 1.76: Ranwell&apos;s 1951–53 water-table readings against the SSM hindcas |
...
| `fig_msl5_vs_summer_min_projection.png` | report9.odt | Figure 78 | Figure 1.75: Projected shift in the five-year mean spring water level (ΔMSL5, bl |
