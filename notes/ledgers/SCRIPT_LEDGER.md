...
| 26 | 26_van_willegen_msl.py | 1.8.0 | 01_climate.csv, 01_wells_clean.csv, 01_wells_extended.csv, 01_wells_provenance.csv, 01_well_elevations.csv, 02_cluster_stats.csv, 03_master_data.csv, 06_pear_…, 03_regional_averages.csv (Method B, cluster-centroid MSL5), 06_pear_membership_audit_sitewide.csv (extended network) | 26_msl_5yr_per_well.csv, 26_msl_5yr_per_cluster*.csv, 26_msl_annual_per_well.csv, 26_equilibrium_wetness_index_per_well.csv, 26_ewi_msl5_comparison.csv, 26_ebf_comparison.csv, 26_report_numbers.csv (+msl5_n_* counts), 26_metric_diagnostics_per_well.csv, 26_index_precision_by_cluster.csv | 26_msl_5yr_map.png, 26_msl_5yr_trajectory.png, 26_msl_5yr_quadrat_wells.png, 26_ebf_prediction_scatter.png, 26_metric_diagnostics.png | R8,MS | **DRIFT** |
