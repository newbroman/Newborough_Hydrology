...
why C4 and C5 return β₁ of 2.48 and 2.41 against 3.76–4.58 in the open dune.
...
(C4 0.315, C5 0.358) sit at or above the open-dune range and fall inside it once
corrected (C4 0.261, C5 0.330).
...
under the current partition the numerator wins (0.315 → 0.261). Both are the
...
case (c). At C4, β₁ = 2.476, so the spurious addition is `β₁·I·P̄` ≈ 0.59·P̄:
