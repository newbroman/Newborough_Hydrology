...
| 15 | 32, 33, 35, 36, 37, 37b (observed differential change, envelope, and driver validation) | 36–41 | Secular differential water-table drift (32, report Fig 70); climate-swing amplification + drought-floor surface (33, report Figs 72 and 59); per-well climate-sensitivity coefficient (35); absolute climate-removed per-well secular trend (36, Figure 71); predicted-vs-observed driver validation (37); comparative driver footing across forest/scrape/coast on common currencies (37b) — all analytical-default |
...
differential water-table drift (Script 32, step 36, report Fig 70), climate-swing
amplification and drought-floor surface (Script 33, step 37, report Figs 72 and 59), the
per-well climate-sensitivity coefficient (Script 35, step 38), the absolute
climate-removed secular trend map (Script 36, step 39, Figure 71), the
