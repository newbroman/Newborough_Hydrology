...
differential water-table drift (Script 32, step 36, report Fig 68), climate-swing
amplification and drought-floor surface (Script 33, step 37, report Figs 70 and 59), the
per-well climate-sensitivity coefficient (Script 35, step 38), the absolute
climate-removed secular trend map (Script 36, step 39, Figure 69), the
