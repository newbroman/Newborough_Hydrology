...
#         < 12) at the record ends, despite those years being flagged "*"
#         in the Notes column.  Now averages complete years only
#         (Months_complete == 12).  Affects both the full-record and the
#         _short well-period tables.
