...
====================================================================================
09e — CEH36 SCRAPING ROBUSTNESS ANALYSIS
====================================================================================
Purpose
-------
...
CSVs:
  09e_report_numbers.csv — robustness step estimates for citation
...
def main():
    ...
    if len(baseline_X) >= 24:
        ...
        warn(f"Insufficient baseline overlap ({len(baseline_X)} months, need >=24)")
    ...
    if len(ts_base) >= 36:
        ...
        ts_fwd["residual"] = np.nan
        ssm_step = np.nan
        warn(f"Insufficient baseline for SSM calibration ({len(ts_base)} months, need >=36)")
