...
DIR_11B since the input lives there). Wired into run_analysis.py as a successor
step to 11b, following the 14b → Script 14 pattern; the canonical phase and step
index are in outputs/pipeline_manifest.json.
"""
