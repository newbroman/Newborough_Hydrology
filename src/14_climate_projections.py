...
def render_winter_figure(
    ...
    ax.yaxis.grid(True, color="#eaeaea", linewidth=0.5, linestyle="-", zorder=0)
    ax.set_axisbelow(True)
    ax.legend(loc="lower right", fontsize=8.2, frameon=True, framealpha=0.92, edgecolor="#cccccc")
...
def render_stacked_figure(
    ...
    ax_bot.legend(loc="lower right", fontsize=8.0, frameon=True, framealpha=0.92, edgecolor="#cccccc")
