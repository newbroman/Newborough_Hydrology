...
def main():
    ...
    step(f"Computed climatologies for {len(clim_df)} wells.")

    # Save table
    clim_df.to_csv(INT_24_CLIMATOLOGY_TABLE, index=False)
    saved(f"{INT_24_CLIMATOLOGY_TABLE.name}")
