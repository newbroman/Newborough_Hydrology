...
Cluster-framework diagnostic. Enters run_analysis.py at Phase 14 Step 32.
...
#         directory. Entered run_analysis.py at Phase 14 Step 32. No change
#         to procedure; outputs byte-identical to the standalone
