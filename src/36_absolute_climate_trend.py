...
Pipeline-integrated in the driver-validation phase of run_analysis.py, before
Scripts 37/37b; canonical step index in outputs/pipeline_manifest.json. Reads pipeline
