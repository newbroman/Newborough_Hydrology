...
KNOWN_DANGLING = {
    # 2026-09-04, T-10 CLOSED. The frozen inventory is now empty: every document
    # the live source cited but the repository lacked has been resolved by one of
    # this gate's own sanctioned means -
    #   recovered  - NRG_methods_code_audit_2026-08-14.md (Claude project store),
    #                DIAGNOSTIC_REPORT_script_26_cluster_assignment.md (trash);
    ...
    #                (labelled 2026-09-04 reconstructions from the surviving code + MS);
    #   repointed  - the script-20 residual-field defect note and the 2026-08-08
    #                pipe_top_upstand changelog;
    #   built      - TABLE_LEDGER.md, DOC_LEDGER.md and FIGURE_LEDGER.md, now
    #                generated by tools/build_table_ledger.py, build_doc_ledger.py
    #                and build_figure_ledger.py;
    #   retired    - BETA2_DECOMPOSITION.md -> RETIRED;
    #   exempted   - CHANGELOG.md and the claude/ store-path rule (main()).
    # See D-122 and working/updates/T10_RECOVERY_2026-08-26.md. This dict is kept
    # (empty) so the mechanism and its history remain in one place; the gate's job
    # was always to stop it GROWING, and an entry is added here only after deciding,
    # explicitly, that a document will not be recovered, rebuilt or repointed.
}
...
_GENERATED = ("working/PROJECT_DIARY.md", "notes/PROJECT_HISTORY.md",
              # generated by build_value_ledger.py; untracked-value context
              # snippets quote prose verbatim and can contain truncated
              # filename fragments that are not real references.
              "notes/ledgers/VALUE_LEDGER.md", "notes/ledgers/VALUE_LEDGER_report.md",
              "notes/ledgers/PROVENANCE_LEDGER.md", "notes/ledgers/VALUE_REGISTER.md")
